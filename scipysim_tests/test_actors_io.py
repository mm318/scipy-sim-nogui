...
from scipysim.actors.io import NumpyReader, NumpyWriter
from scipysim.actors.io import TextReader, TextWriter
from scipysim.actors.io import Bundle, Unbundle
...
class FileIOTests(unittest.TestCase):
    ...
    def test_file_write(self):
        ...
        fileWriter = NumpyWriter(self.chan, self.f.name)
    ...
    def test_file_read(self):
        ...
        fileWriter = NumpyWriter(self.chan, fileName)
        fileWriter.start()
        fileWriter.join()

        fileReader = NumpyReader(output_channel=self.chan, file_name=fileName)
        fileReader.start()
        fileReader.join()
